...
darkMode.addEventListener('click', () => {
    ...
    .add({
        targets : ".darkmodeBtn",
        backgroundColor : toggle ? "rgb(0, 211, 128)" : "rgb(166, 141, 173)"
    })
    ...
    if(toggle === true)
    {
        document.querySelector('.bigImg').src = "picture/bigimg-2.jpg"
    }
    else if(toggle === false)
    {
        document.querySelector('.bigImg').src = "picture/bigimg.jpg"
    }
})
